export async function onRequest(context){
  ...
  if(isHome){
    ...
    const bridgeTag='<script src="/supabase-user-bridge.js?v=20260904-6"></script>';
    ...
    body=body.includes('</body>')?body.replace('</body>','<script src="/realtime-queue-refresh.js?v=20260904-6"></script></body>'):body+'<script src="/realtime-queue-refresh.js?v=20260904-6"></script>';
